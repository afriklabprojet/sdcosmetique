...
export default function WishlistTab({ wishlistItems, removeFromWishlist }: WishlistTabProps) {
  return (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                {wishlistItems.length === 0 ? (
                  <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #EDE8E0', padding: '48px 24px', textAlign: 'center' }}>
                    ...
                    <Link href="/boutique" className="account-empty-cta" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: 44, padding: '10px 24px', background: '#3D1400', borderRadius: 10, color: '#fff', fontSize: 13, fontWeight: 700, textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Découvrir nos produits</Link>
                  </div>
                ) : (
                  <div className="dash-1to3" style={{ gap: 16 }}>
