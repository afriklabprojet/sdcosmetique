...
export default function FaceCategoryPage() {
  ...
  useEffect(() => {
    fetchSiteConfigSection('hero_face').then(setHero).catch(() => {});
  }, []);
  ...
  return (
    <div className={styles.page}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroContent}>
            ...
            <div className={styles.heroActions}>
              ...
              <span className={styles.heroBadge}>Pour peaux mélanisées</span>
            </div>
          </div>
      ...
      <CategoryBrowser styles={styles} category="face" unitLabel="produit" emptyScope="nos soins visage" />
    </div>
  );
}
