...
interface AddressesTabProps {
  ...
  readonly handleSaveAddress: () => void;
  readonly handleSetDefaultAddress: (id: string) => void;
  readonly handleDeleteAddress: (id: string) => void;
}

export default function AddressesTab({
  isMobile, addresses, addrForm, setAddrForm, showAddrForm, setShowAddrForm,
  editingAddr, setEditingAddr, handleSaveAddress, handleSetDefaultAddress, handleDeleteAddress,
}: AddressesTabProps) {
  return (
