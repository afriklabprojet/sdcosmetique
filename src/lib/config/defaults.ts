...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  hero_kit_levre: {
    eyebrow: 'Soins des lèvres',
    title: 'Kit Lèvre',
    titleAccent: 'la beauté sublimée',
    lead: 'Des kits soins complets pour des lèvres douces, hydratées et sublimées.',
    image: '/categories/kits.png',
  },
  hero_minceur: {
    eyebrow: 'Soins minceur',
    title: 'Minceur',
    titleAccent: 'la silhouette révélée',
    lead: 'Des soins ciblés pour raffermir, drainer et sculpter votre silhouette.',
    image: '/categories/corps.png',
  },
