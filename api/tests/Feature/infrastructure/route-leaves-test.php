...
it('applies throttle middleware to public mutation endpoints', function (): void {
    ...
    foreach (['orders.payments.store', 'webhooks.terminal', 'webhooks.jeko-pay', 'newsletter-subscriptions.store', 'contact-messages.store', 'reviews.store', 'quiz-submissions.store', 'testimonials.store'] as $name) {
